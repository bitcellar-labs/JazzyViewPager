...
public class JazzyViewPager extends ViewPager {
  ...
  public enum TransitionEffect {
    Standard, Tablet, CubeIn, CubeOut, FlipVertical, FlipHorizontal, Stack, Slide, ZoomIn, ZoomOut, RotateUp, RotateDown, Accordion
  }
  ...
  protected void animateSlide(View left, View right, float positionOffset, int positionOffsetPixels) {
    if (mState != State.IDLE) {
      if (right != null) {
        manageLayer(right, true);
        mScale = (1 - SCALE_MAX) * positionOffset + SCALE_MAX;
  ...
  public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
    ...
    case Stack:
      ...
      break;
    case Slide:
      animateSlide(mLeft, mRight, effectOffset, positionOffsetPixels);
      break;
    case ZoomIn:
